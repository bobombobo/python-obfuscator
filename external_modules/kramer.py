#pulled from: https://github.com/billythegoat356/Kramer
...
Kramer(_n1_=False,_n2_=False,_sparkle='''{content}''')""".strip().replace("_n1_",n_1.replace("self.", "")).replace("_n2_",n_2.replace("self.", "")).replace("_n3_",n_3.replace("self.", "")).replace("_n4_",n_4.replace("self.", "")).replace("_n5_",n_5).replace("_n6_",n_6).replace("_n7_",n_7).replace("_n8_",n_8).replace("_n9_",n_9.replace("self.", "")).replace("_n10_",n_10.replace("self.", "")).replace("_n12_",n_12.replace("self.", ""))
    return _final_content_




def kramer_func(content):
